...
update_readme_with_badges() {
    ...
    local badge_markdown='<a href="'$svg_file'"><img src="'$svg_file'" alt="Project Badges" title="Generated by badges.sh from github.com/cdvelop/devscripts"></a>'
...
main() {
    ...
    if [ "$should_write" = true ]; then
        ...
        success "Generated badges SVG: $svg_file"
        success "Valid badges generated: $GENERATED_BADGES_COUNT"
    else
